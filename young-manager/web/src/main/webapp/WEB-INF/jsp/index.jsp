                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/coursedetails?cid=${h.cid}">
                                ...
                                <div class="status">
                                    ...
                                    <p><span class="planing">正在开课</span><span><i class="layui-icon layui-icon-rate" style="font-size: 15px; color: #393D49;"></i>${h.courseSelectnum}</span></p>
                                </div>

                                <div class="person">
                                    <c:if test="${h.schName.trim() eq '东南大学'}">
                                        <span><i class="layui-icon layui-icon-read" style="font-size: 16px; color: #393D49;"></i></span>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/coursedetails?cid=${c.cid}">
                                ...
                                <div class="status">
                                    ...
                                    <p><span class="planing">正在开课</span><span><i class="layui-icon layui-icon-rate" style="font-size: 15px; color: #393D49;"></i>${c.courseSelectnum}</span></p>
                                </div>
                                <div class="person">
                                    ...
                                    <c:if test="${c.schName.trim() eq '中国科技大学'}">
                                        <span><i class="layui-icon layui-icon-read" style="font-size: 16px; color: #393D49;"></i></span>
